...
__attribute__((optimize(3))) void matrix_init_kb(void) {
    matrix_init_user();
}

__attribute__((optimize(3))) void matrix_scan_kb(void) {
    matrix_scan_user();
}

__attribute__((optimize(3))) void matrix_init_user(void) {}

__attribute__((optimize(3))) void matrix_scan_user(void) {}
